...
export default function Hero({ consultant, tabIndex, setTabIndex }) {
            ...
            >
                ...
                >
                    ...
                    <span className="text-gray-400 ">
                        <img src={consultant.profilePhoto || '/Images/placeholder.png'} alt="Profile" className="h-full w-full object-cover rounded-2xl" />
                    </span>
                </Box>
            </Flex>
        </Box>
