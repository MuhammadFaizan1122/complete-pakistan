        ...
        <VStack align="flex-start" spacing={6} >
            ...
            <Box className="p-4 rounded-lg border-l-[4px] border-black" border={'1px solid'} borderColor={'gray.400'} bg={'gray.50'} w="full">
                <Flex>
                    ...
                    <Box>
                        <Text fontWeight="bold">Tayyeb Enterprises</Text>
                        <Text fontSize="sm" color="gray.600">Client: Ahmed Tayyeb</Text>
                        <Text fontSize="sm" color="gray.600">Visa Processing</Text>
                        <Text fontSize="sm" color="gray.600" mt={2}>"Excellent visa processing service with professional guidance throughout."</Text>
